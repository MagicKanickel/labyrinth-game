function applyPush(board, extraTile, side, index, players) {
...
function isReversePush(lastPush, side, index) {
  if (!lastPush) return false;
  return lastPush.side === OPPOSITE[side] && lastPush.index === index;
}

function getAllPushPositions(lastPush) {
  const positions = [];
...
module.exports = { applyPush, isReversePush, getAllPushPositions };
